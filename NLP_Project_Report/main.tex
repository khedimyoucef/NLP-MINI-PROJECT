...
\begin{figure}[H]
\centering
\includegraphics[width=1\textwidth]{pics/placeholder_pipeline.png} % PLACEHOLDER
...
\begin{figure}[H]
\centering
\includegraphics[width=0.8\textwidth]{pics/placeholder_lora.png} % PLACEHOLDER
...
\begin{figure}[H]
\centering
\includegraphics[width=0.8\textwidth]{pics/placeholder_dataset_stats.png} % PLACEHOLDER
